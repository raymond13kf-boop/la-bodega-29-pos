...
import { 
  ...
  Package, Inbox, FileText, Users, X, ShieldAlert, Receipt, TrendingUp, Truck
} from 'lucide-react';
import './Layout.css';
...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { path: '/boletas', icon: <Receipt size={20} />, label: 'Facturas/Boletas', show: perms?.can_inventory },
    { path: '/proveedores', icon: <Truck size={20} />, label: 'Proveedores', show: perms?.can_inventory },
